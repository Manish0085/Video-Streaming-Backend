  ...
  return (
    <div className="text-white">
      <Card className="flex flex-col items-center justify-center">
        ...
        <div>
          <form noValidate className="flex flex-col space-y-7" onSubmit={handleForm} >
      ...
      <TextInput 
      value={meta.title}
      onChange={formFieldChange} name="title"
    ...
    "/>
        ...
        <div className="">
            {uploading && (
              <Progress   progress={progress} textLabel="Uploadiing.." size="lg" labelProgress labelText />
            )}
        </div>
